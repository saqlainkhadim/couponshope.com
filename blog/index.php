...
<li><a  id='categ' class="active" href="#"><span class='fa fa-edit' style='font-size:18px;'></span> Blog</a></li>
...
while($records=mysqli_fetch_assoc($query)){
    	...
    	echo "<div id='coupon-div' class='container'>";
           ...
           echo "<div id='blog-details' class='col-lg-10 col-md-9 col-sm-9 col-xs-12 container-fluid'>";
               ...
               echo "<div id='blog-readmore'><a target='_blank' href='../blogs/?blog=".$records['title']."'><div class='btn btn-primary'>Read Full Story</div></a></div>";
