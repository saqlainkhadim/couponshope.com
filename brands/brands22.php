...
$username='root';
$pwd='';
$sqlt="SELECT * FROM stores where store='".$s."'";
...
<?php
$sqlt="SELECT * FROM couponlisting INNER JOIN stores ON couponlisting.store_name= stores.store where store_name='".$s."' ORDER BY rand()";
$recordst=mysqli_query($conn, $sqlt);
