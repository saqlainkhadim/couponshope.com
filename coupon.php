...
<meta charset="utf-8">
<title>Coupons - Coupon Slush</title>
...
<li><a  id='coup' class="active" href="coupon.php"><span><img src="media/coup2.png" width="20px" style="margin-top:-5px"/></span>Coupons</a></li>
...
<div id="side2">Available Coupon Codes
           <?php
$host='localhost';
$username='root';
$pwd='';
...
$sqlt="SELECT * FROM couponlisting INNER JOIN stores ON couponlisting.store_name= stores.store where couponlisting.code_type='Reveal Code' ORDER BY rand()";
    ...
    <div id='coup-div' class='container'>
    	...
    	<div id='coup-1' class='col-lg-2 col-md-2 col-sm-4 col-xs-12'>
                    ...
                    <div id='incoup-1' class='container'>
                        ...
                        <div id='code'>".$couponlistingt['code']."</div>
                    </div>
